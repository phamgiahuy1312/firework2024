...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const fireworksSound = document.getElementById('fireworks-sound'); // Giả sử bạn có một thẻ audio với id là 'fireworks-sound'

    // Bắt đầu phát nhạc khi trang web được tải
    backgroundMusic.play();
    fireworksSound.play(); // Bắt đầu phát âm thanh pháo hoa khi trang web được tải
